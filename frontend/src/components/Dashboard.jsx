        ...
        <div className="flex gap-3">
          {data.downloadUrl && (
            <a 
              ...
              className="bg-primary text-white px-6 py-2 rounded shadow-sm flex items-center justify-center gap-2 hover:bg-on-primary-fixed-variant transition-all font-label-md uppercase tracking-wider no-underline"
            >
              <Database size={16} /> 
